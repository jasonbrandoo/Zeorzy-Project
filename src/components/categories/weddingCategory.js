...
const weddingCategory = () => {
  ...
  return (
    <>
      <StyledContainer>
        <StyledLink
          to={`/wedding/${data.images1.sourceInstanceName}`}
      ...
      <StyledContainer>
        <StyledLink
          to={`/wedding/${data.images2.sourceInstanceName}`}
      ...
      <StyledContainer>
        <StyledLink
          to={`/wedding/${data.images3.sourceInstanceName}`}
      ...
      <StyledContainer>
        <StyledLink
          to={`/wedding/${data.images4.sourceInstanceName}`}
